...
public class Aluno extends TempPessoa implements Observer 
{
    //TERIA QUE TER MATRICULA NOS OBJETOS MAS NÉ
    private Matricula m;
    public Aluno() {
    ...
    public Aluno(String cpf, String nome, String tel, String rua, String cidade, String CEP, String sexo, String email, LocalDate dt_nasc) {
        super(cpf,nome,tel,rua,cidade,CEP,sexo,email,dt_nasc);
    }
